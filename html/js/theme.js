...
$(function () {
    ...
    var btnIncreaseDecrease = document.querySelectorAll('.btn-items-decrease, .btn-items-increase');

    for (let i = 0; i < btnIncreaseDecrease.length; i++) {
        btnIncreaseDecrease[i].addEventListener("click", function () {
            for (let sibling of this.parentNode.children) {
                if (sibling.classList && sibling.classList.contains('input-items')) {

                    // It's decrease button
                    if (this.classList.contains('btn-items-decrease')) {
                        if (parseInt(sibling.value, 10) >= 1) {
                            sibling.value = parseInt(sibling.value, 10) - 1
                        }
                        // It's increase button
                    } else if (this.classList.contains('btn-items-increase')) {
                        sibling.value = parseInt(sibling.value, 10) + 1
                    }
